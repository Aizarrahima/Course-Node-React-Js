            ...
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start mr-10">
                <div className="flex-shrink-0 flex items-center mr-10">
                  <img className="hidden lg:block h-10 w-auto" src="/assets/techlog.png" alt="Workflow" />
                  <img className="hidden lg:block h-5 ml-3 w-auto mr-10" src="/assets/TECHCO.png" alt="Workflow" />
                </div>
                <div className="hidden sm:block sm:ml-10 mx-10">
                  <div className="menu flex space-x-4 ml-10">
                    ...
                    <NavLink to="/userClass" className="no-underline text-gray-800 hover:bg-blue-900 hover:text-white px-3 py-2 rounded-md text-sm font-medium " aria-current="page">User'sClass</NavLink>
